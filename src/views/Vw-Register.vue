<template>
  <v-container fluid class="background">
    ...
    <div class="center">
      <v-sheet class="d-flex align-center justify-center text-center" color="transparent" rounded :width="900">
        <div class="center2">
              ...
              <v-col align-self="center" class="my-10" cols="4">
                <div id="form">
                  <v-form ref="form" fast-fail>
                    ...
                    <v-text-field clearable label="Email" type="email" prepend-icon="fa-solid fa-envelope"
                      variant="underlined" class="input" v-model="userForm.email" :rules="[
                        (val) =>
                          (val && val.length > 0) ||
                          'Este campo es obligatorio',
                        isValidEmail,
                    ...
                    <v-text-field clearable label="Contraseña" type="password" prepend-icon="fa-sharp fa-solid fa-key"
                      variant="underlined" class="input" v-model="userForm.password" :rules="[
                        (val) =>
                          (val && val.length > 0) ||
                          'Este campo es obligatorio',
                        (val) =>
